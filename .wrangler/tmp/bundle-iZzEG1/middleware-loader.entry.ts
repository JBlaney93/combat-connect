...
import {
	...
	__facade_invoke__,
	__facade_register__,
} from "/home/james/workspace/combat-connect/node_modules/wrangler/templates/middleware/common.ts";

import worker from "/home/james/workspace/combat-connect/.wrangler/tmp/bundle-iZzEG1/middleware-insertion-facade.js";

// We need to preserve all of the exports from the worker
export * from "/home/james/workspace/combat-connect/.wrangler/tmp/bundle-iZzEG1/middleware-insertion-facade.js";
